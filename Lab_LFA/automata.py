...
class Automata:
    ...
    def load_automata(self)->dict:
        with open(self.file, 'r') as config_file:
            ...
            #TODO: handleing of multiple automatas
            ...
            #store all the config settings in a pythin dictionary for easier manipulation
            settings_dict={}
            ...
            #delete the square brackets then transform the informations into a list
            ...
            #Reasoning: to stay away from many imbricated if statements
    ...
    def run_automata(self, data:str) -> None:
        ...
        #parse trough input data and change the state accordingly
        for symbol in data:
...
#run automata
MyAutomata = Automata("automata.cfg")
